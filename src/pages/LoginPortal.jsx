    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-6">
      <div className="max-w-6xl w-full">
        ...
        >
              ...
              <div className="text-center space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 font-light tracking-wide leading-relaxed">
                    Find your next career opportunity through curated walk-in interviews
                  </p>
                </div>
                  ...
                  {candidateFeatures.map((feature, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="font-light tracking-wide">{feature.title}</span>
            ...
            >
              <div className="text-center space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 font-light tracking-wide leading-relaxed">
                    Find qualified candidates faster with our direct interview platform
                  </p>
                </div>
          ...
          {/* Divider */}
          <motion.div variants={itemVariants} className="flex items-center justify-center space-x-4 max-w-sm mx-auto">
            <div className="w-16 h-px bg-gray-300"></div>
            <span className="text-gray-500 font-light tracking-wide text-sm">Or</span>
            <div className="w-16 h-px bg-gray-300"></div>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-center gap-2 text-gray-500 mb-2">
              ...
              <span className="font-light tracking-wide text-sm">Enterprise-grade security</span>
            </div>
