        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label htmlFor="email" className="text-xs font-light text-gray-600 tracking-wide uppercase">
                Email Address
              </label>
            ...
            {/* Password Field */}
            <div className="space-y-2">
              <label htmlFor="password" className="text-xs font-light text-gray-600 tracking-wide uppercase">
                Password
              </label>
              <div className="relative">
